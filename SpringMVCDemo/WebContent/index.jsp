...
<div class="container">
<!-- convert html form/boostroop code to spring form tag -->
<form:form cssClass="form-signin" modelAttribute="loginFormBean" action="doLogin.html" method="post">
<h2 class="form-signin-heading">Please sing in</h2>

<label for="username" class="sr-only">Username</label>
<form:input path="username" id="username" cssClass="form-control" placeholder="Username" />
